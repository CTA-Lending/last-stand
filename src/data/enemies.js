...
export const ENEMIES = {
  ...
  // 七情 Boss
  emo_nu:  { name: '嗔怒之魔', form: 'brute',    armorType: 'heavy', hpMult: 1.4, speedMult: 0.9,  bountyMult: 1.5, radius: 18, color: '#d23a2a', boss: true, dmg: 22, atk: 1.2, ability: { type: 'enrage',        threshold: 0.4, boost: 2.0 } },
  emo_ai:  { name: '悲哀之魔', form: 'mourner',  armorType: 'heavy', hpMult: 1.4, speedMult: 0.8,  bountyMult: 1.5, radius: 18, color: '#3a6fd2', boss: true, dmg: 18, atk: 1.1, ability: { type: 'slowTowerAura', radius: 110, factor: 0.6 } },
  emo_ju:  { name: '恐懼之魔', form: 'dread',    armorType: 'magic', hpMult: 1.2, speedMult: 0.95, bountyMult: 1.5, radius: 17, color: '#7a3fd0', boss: true, dmg: 16, atk: 1.0, ability: { type: 'fearAura',      radius: 110 } },
  ...
  yu_sheng: { name: '聲慾', form: 'siren',    armorType: 'light',  hpMult: 1.1, speedMult: 1.2,  bountyMult: 1.3, radius: 15, color: '#7fd0e0', boss: true, dmg: 16, atk: 1.0, ability: { type: 'slowTowerAura', radius: 100, factor: 0.7 } },
